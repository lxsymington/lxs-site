...
The methodology we just discussed is actually quite common and known as linear interpolation. The formula for it is:

$$
{\displaystyle y=y_{0}+(x-x_{0}){\frac {y_{1}-y_{0}}{x_{1}-x_{0}}}}
$$

This will need to be applied for each channel.
