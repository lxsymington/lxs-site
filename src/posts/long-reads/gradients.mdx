...
${\sqrt{2}}$ (1.4142135623 to 10 decimal places) and the area of that line is less than an equivalent length row or
column of pixels.  So let's try and make the pixels surrounding the 0 thickness sections a shade of the line colour,
much like boundary pixels in anti aliasing.
